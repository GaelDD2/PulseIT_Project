...
export function DetailTecnico() {
    ...
    if (error) return <ErrorAlert title={t('common.errorLoadingDetail')} message={error} />;
                        ...
                        <CardContent className="p-6 space-y-6">
                            <div className="flex flex-wrap items-center gap-x-10 gap-y-4">
                                <div className="flex items-center gap-4">
                                    ...
                                    <span className="font-semibold">{t('technicians.availability')}:</span>
                                ...
                                <div className="flex items-center gap-4">
                                    ...
                                    <span className="font-semibold">{t('technicians.currentLoad')}:</span>
                                    <p className="text-muted-foreground">
                                ...
                                {tecnico.data.especialidades && tecnico.data.especialidades.length > 0 && (
                                    <div>
                                        <div className="flex items-center gap-4 mb-2">
                                            ...
                                            <span className="font-semibold">{t('technicians.specialties')}:</span>
                                        </div>
